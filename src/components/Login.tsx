			...
			<main className="container max-w-7xl min-h-screen mx-auto flex justify-center items-center">
				<form className="max-w-2xl w-full p-5 sm:p-0" onSubmit={(ev) => onSubmit(ev)}>
					...
					<div className="mb-4">
						<input
							type="text"
							className="bg-slate-50  border border-gray-200 text-gray-700 text-base rounded-lg focus:ring-1 focus:ring-blue-700 focus:border-blue-700  w-full p-4"
					...
					<NavLink to={"/home"}>
						<button type="button" className="text-white bg-redrose  hover:bg-red-800 focus:ring-2 focus:outline-none focus:ring-red-300 font-medium rounded-lg text-md w-full telephone:w-auto px-5 py-2 text-center transition-colors duration-200 ease-in">
						กลับหน้าหลัก
						</button>
					</NavLink>
					
					<button type="submit"
						className="text-white bg-limegreen hover:bg-green-500 focus:ring-2 focus:outline-none focus:ring-green-300 font-medium rounded-lg text-md w-full telephone:w-auto px-5 py-2 text-center mt-3 telephone:ml-2 telephone:mt-0 transition-colors duration-200 ease-in"
					>
						เข้าสู่ระบบ
					</button>
					
					<div className="inline-block text-white bg-blue-500 hover:bg-blue-600 focus:ring-2 focus:outline-none focus:ring-blue-500 font-medium rounded-lg text-md w-full telephone:w-auto px-5 py-2 text-center mt-3 telephone:ml-2 telephone:mt-0 transition-colors duration-200 ease-in">
						<FacebookLogin
							appId={`${facebookAppId}`}
							size="medium"
					...
					<NavLink to={"/email"}>
						<button type="button" className="text-white bg-gray-500 hover:bg-gray-600 focus:ring-2 focus:outline-none focus:ring-gray-300 font-medium rounded-lg text-md w-full mt-3 telephone:w-auto telephone:ml-2 px-5 py-2 text-center transition-colors duration-200 ease-in">
							ลืมรหัสผ่าน
						</button>
					</NavLink>
				</form>
